...
=======
          ...
          <button onClick={() => setIsModalOpen(true)} className="w-10 h-10 bg-[#e4e3dd]/60 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-black dark:text-gray-100 rounded-lg flex items-center justify-center cursor-pointer">
>>>>>>> Stashed changes
