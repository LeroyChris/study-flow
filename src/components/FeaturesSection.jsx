    ...
    <>
      <section id="features">
        <div className="flex-col bg-mist-100 dark:bg-gray-800 mt-50 py-20 text-center">
          <h3 className="text-[30px] font-[family-name:var(--font-family-poppins)] font-bold text-gray-800 dark:text-gray-100">
