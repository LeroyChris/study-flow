...
export default function Header({ onNavigate }) {
  return (
    <header className="sticky top-0 left-0 right-0 z-50 backdrop-blur-md bg-white/20 dark:bg-gray-900/80 border-b border-white/10 dark:border-gray-700/50 px-8 py-4 flex justify-between items-center">
