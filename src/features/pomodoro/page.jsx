    ...
    <div className="min-h-screen flex">
      ...
      <main className="flex-1 bg-brand-warm dark:bg-gray-900 p-8">
        <div className="flex justify-between items-center max-w-5xl mx-auto mb-6 px-2">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 font-poppins">Pomodoro Timer</h1>
          <button onClick={() => setIsModalOpen(true)} className="w-10 h-10 bg-gray-200/60 dark:bg-gray-700 text-black dark:text-gray-100 rounded-lg flex items-center justify-center cursor-pointer hover:bg-gray-200">
