...
export default function FlashcardView({ onNavigate }) {
  ...
  if (!activeDeck) {
    return (
      <Layout title="Flashcards" currentView="flashcard" onNavigate={onNavigate}>
  ...
  /* ════════════════════════════════════════════════
     ...
     ════════════════════════════════════════════════ */
  const deckTitle = isStudying || studyResult ? `${activeDeck.title} — Study` : activeDeck.title
  return (
    <Layout title={deckTitle} currentView="flashcard" onNavigate={onNavigate}>
